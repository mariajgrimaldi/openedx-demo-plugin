...
"""
openedx-demo-plugin documentation build configuration file.
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'openedx_demo_plugin.settings.test'
django_setup()
...
project = 'openedx-demo-plugin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Open edX Demo Plugin'
...
#
# html_title = 'openedx-demo-plugin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Where all the extensions & tools for the Open edX Demo Site installation live!',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_demo_plugin'),
                os.path.join(root_path, 'openedx_demo_plugin/migrations')])
